...
public class Aluno extends Pessoa {
	 ...
	 * provavelmente e uma enumeracao.
	 * 
	 ...
	 * lista de notas do aluno. Solicita ao usu�rio a quantidade de notas 
	...
	*/
	...
	public ArrayList<Double> adicionarNota() {
		...
		for (int i = 0; i < qtdNota; i++) {
			...
			double notaAdd = Menu.inserirDouble();
	 ...
	 * divide a soma pelo n�mero de notas para obter a media.
	 */
	 ...
	 * para retornar uma representa��o em formato de string dos dados do aluno,
